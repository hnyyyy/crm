...
<html>
 ...
 <body class="main">
	...
	<form:form id="chanceForm" action="${ctp}/chance/create/${chance.id}" method="POST" modelAttribute="chance">
		...
		<table class="query_form_table" border="0" cellPadding="3" cellSpacing="0">
			...
			<tr>
				...
				<th>创建时间</th>
				<td><form:input path="createDate"  id="createDate"/><span class="red_star">*</span></td>
			</tr>
		</table>
		<br /><br>
  </form:form>
